...
export default function DiscountSlider() {
  ...
  return (
    <div className="container py-8">
      <div className="discount-slider-container  flex flex-col gap-4">
              ...
              return (
                <SwiperSlide key={item._id}>
                  <Link to={`/product/${item._id}`}>
                    <div className="card bg-base-100 py-4 my-2 shadow-sm hover:shadow-lg transition duration-300">
                      <figure>
                        <img
